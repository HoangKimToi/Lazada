...
public class DataSanPham extends SQLiteOpenHelper {
    ...
    public static String TB_GioHang_SOLUONG_TONKHO = "SOLUONGTONKHO";
    ...
    public void onCreate(SQLiteDatabase db) {
        String tbGioHang = "CREATE TABLE "+TB_GioHang+" ("+TB_GioHang_MASP+" INTEGER PRIMARY KEY,"+TB_GioHang_TENSP+" TEXT,"+TB_GioHang_GIATIEN+" REAL,"+TB_GioHang_HINHANH+" BLOB,"+TB_GioHang_SOLUONG+" INTEGER,"+TB_GioHang_SOLUONG_TONKHO+" INTEGER);";

        String tbYeuThich = "CREATE TABLE "+TB_YeuThich+" ("+TB_YeuThich_MASP+" INTEGER PRIMARY KEY,"+TB_YeuThich_TENSP+" TEXT,"+TB_YeuThich_GIATIEN+" REAL,"+TB_YeuThich_HINHANH+" BLOB);";
