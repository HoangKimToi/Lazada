package com.t3h.lazada.Connect;
...
public class DowdloadJSON extends AsyncTask<String,Void,String> {
    String duongdan;
    List<HashMap<String,String>> attrs;
    StringBuilder dulieu;
    boolean method = true;

    public DowdloadJSON(String duongdan){
        this.duongdan = duongdan;
        method = true;
    }

    public DowdloadJSON(String duongdan, List<HashMap<String,String>> attrs){
        this.duongdan = duongdan;
        this.attrs = attrs;
        method = false;
    }
